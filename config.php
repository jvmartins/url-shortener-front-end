...
define( 'YOURLS_DB_USER', 'palmeir01' );

/** MySQL database password */
define( 'YOURLS_DB_PASS', 'yourlsJa' );

/** The name of the database for YOURLS */
define( 'YOURLS_DB_NAME', 'palmeir01' );

/** MySQL hostname */
define( 'YOURLS_DB_HOST', 'mysql15.kinghost.net' );
...
define( 'YOURLS_SITE', 'http://palmeir.as' );
...
define('YOURLS_COOKIEKEY', 'A~2jT4yp1E}Lyy5GpKvz[O50Jw8mt[GM0mM3SsB6');

/**  Username(s) and password(s) allowed to access the site */
$yourls_user_passwords = array(
	'custodio' => 'Consulado1',
	'joao' => 'Garotao01',
	'gustavo' => 'Garotao02' // You can have one or more 'login'=>'password' lines
	);
