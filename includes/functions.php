...
function yourls_add_new_link( $url, $keyword = '', $title = '' ) {
	...
	if ( !$url || $url == 'http://' || $url == 'https://' ) {
		...
		$return['customMessage'] = 'URL inválida!';
	...
	if( !$url_exists || yourls_allow_duplicate_longurls() ) {
		...
		if ( $keyword ) {
			...
			if ( !yourls_keyword_is_free($keyword) ) {
				...
				$return['customMessage'] = 'Esta palavra está reservada!';
				...
				$return['customMessage'] = 'URL encurtada com sucesso!';
