...
function yourls_html_logo() {
	...
	?>
	<h1>
		<a href="<?php echo yourls_admin_url('index.php') ?>">
		<img src="<?php yourls_site_url(); ?>/images/yourls-logo.png" alt="PALMEIR.AS" title="PALMEIR.AS" border="0" style="border: 0px;" /></a>
	</h1>
	<?php
...
function yourls_html_footer() {
	...
	<div id="footer"><p>v<?php echo YOURLS_VERSION; echo ' &ndash; '.$num_queries; ?></p></div>
